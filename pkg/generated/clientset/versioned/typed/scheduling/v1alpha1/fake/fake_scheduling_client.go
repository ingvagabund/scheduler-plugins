...
func (c *FakeSchedulingV1alpha1) ClusterScopedResorceses(namespace string) v1alpha1.ClusterScopedResorcesInterface {
	return &FakeClusterScopedResorceses{c, namespace}
}
